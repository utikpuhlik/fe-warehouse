...
export function DownloadPriceBlock() {
    ...
    const handleDownload = async () => {
        try {
            ...
            const filename = res.headers.get("Content-Disposition")?.match(/filename="?([^"]+)"?/)?.[1] ?? `price.${ext}`;
    ...
    return (
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end">
            ...
            <Button className="mt-2 sm:mt-0" onClick={handleDownload} disabled={loading}>

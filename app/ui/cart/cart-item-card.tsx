                        ...
                        <div className="flex justify-between">
                            <div>
                                <h3 className="text-sm font-medium">
                                    <Link href={`/catalogue/${offer.product.sub_category.category.slug}/${offer.product.sub_category.slug}/${offer.product.id}`}>
                                        {offer.product.name}
                                    </Link>
                                </h3>
                                <p className="text-muted-foreground text-xs">
                                    <Link href={`/catalogue/${offer.product.sub_category.category.slug}/${offer.product.sub_category.slug}`}>

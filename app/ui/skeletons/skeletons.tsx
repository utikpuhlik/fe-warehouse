...
export function CardSkeletonV2() {
  return (
    <div className="relative overflow-hidden rounded-xl border bg-background p-4 shadow-sm">
      {/* Content block */}
      <div className="mx-auto mb-4 flex size-[100px] items-center justify-center rounded-xl bg-muted"></div>

      {/* Footer */}
      <div className="flex items-center justify-center">
        <Skeleton className="mb-4 h-10 w-20 rounded-md" />
      </div>
    </div>
  );
}
...
export function BreadcrumbsSkeleton() {
  return (
    <div className="mb-4 flex h-[48px] items-center gap-2">
